...
<form action="{{ route('register') }}" method="POST" class="flex flex-col gap-5 items-center mt-10 dark:text-white">
    @csrf
    ...
    <p>Уже есть аккаунт?
        <a class="text-purple-400 hover:underline transition-all duration-300" href="{{ route('login') }}">
            Вход
        </a>
    </p>
</form>
